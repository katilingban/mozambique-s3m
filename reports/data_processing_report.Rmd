...
The first function recodes the immunisation card retention indicator. The next two functions recode respones to each childhood immunisation dose in the Mozambique national EPI schedule. The fourth function recodes the indicators on full immunisation for children between 1 - 2 years old (by recall and by card), and age-appropriate immunisation for all children in the sample. The final function provides overall recoding and concatenates the various childhood immunisation indicators with the core variables.
