...
```{r moz2, echo = FALSE, eval = TRUE, fig.height = 10, fig.width = 10, fig.align = "center"}
sofala_province |> sf::st_geometry() |> plot(lty = 0)
sofala_district |> sf::st_geometry() |> plot(add = TRUE)
moz_provinces |> sf::st_geometry() |> plot(add = TRUE)
sofala_province |> sf::st_geometry() |> plot(lwd = 2, border = "blue", add = TRUE)
...
```{r moz4, echo = FALSE, eval = TRUE, fig.height = 10, fig.width = 10, fig.align = "center"}
sofala_province |> sf::st_geometry() |> plot(lty = 0)
sofala_district |> sf::st_geometry() |> plot(add = TRUE)
moz_provinces |> sf::st_geometry() |> plot(add = TRUE)
sofala_province |> sf::st_geometry() |> plot(lwd = 2, border = "blue", add = TRUE)
...
```{r moz6, echo = FALSE, eval = TRUE, fig.height = 10, fig.width = 10, fig.align = "center"}
sofala_province |> sf::st_geometry() |> plot(lty = 0)
sofala_district |> sf::st_geometry() |> plot(add = TRUE)
moz_provinces |> sf::st_geometry() |> plot(add = TRUE)
sofala_province |> sf::st_geometry() |> plot(lwd = 2, border = "blue", add = TRUE)
...
```{r moz8, echo = FALSE, eval = TRUE, fig.height = 10, fig.width = 10, fig.align = "center"}
sofala_province |> sf::st_geometry() |> plot(lty = 0)
sofala_district |> sf::st_geometry() |> plot(add = TRUE)
moz_provinces |> sf::st_geometry() |> plot(add = TRUE)
sofala_province |> sf::st_geometry() |> plot(lwd = 2, border = "blue", add = TRUE)
...
```{r moz10, echo = FALSE, eval = TRUE, fig.height = 10, fig.width = 10, fig.align = "center"}
sofala_province |> sf::st_geometry() |> plot(lty = 0)
sofala_district |> sf::st_geometry() |> plot(add = TRUE)
moz_provinces |> sf::st_geometry() |> plot(add = TRUE)
sofala_province |> sf::st_geometry() |> plot(lwd = 2, border = "blue", add = TRUE)
...
```{r moz12, echo = FALSE, eval = TRUE, fig.height = 10, fig.width = 10, fig.align = "center"}
sofala_province |> sf::st_geometry() |> plot(lty = 0)
sofala_district |> sf::st_geometry() |> plot(add = TRUE)
moz_provinces |> sf::st_geometry() |> plot(add = TRUE)
sofala_province |> sf::st_geometry() |> plot(lwd = 2, border = "blue", add = TRUE)
...
```{r moz14, echo = FALSE, eval = TRUE, fig.height = 10, fig.width = 10, fig.align = "center"}
sofala_province |> sf::st_geometry() |> plot(lty = 0)
sofala_district |> sf::st_geometry() |> plot(add = TRUE)
moz_provinces |> sf::st_geometry() |> plot(add = TRUE)
sofala_province |> sf::st_geometry() |> plot(lwd = 2, border = "blue", add = TRUE)
...
```{r moz16, echo = FALSE, eval = TRUE, fig.height = 10, fig.width = 10, fig.align = "center"}
sofala_province |> sf::st_geometry() |> plot(lty = 0)
sofala_district |> sf::st_geometry() |> plot(add = TRUE)
moz_provinces |> sf::st_geometry() |> plot(add = TRUE)
sofala_province |> sf::st_geometry() |> plot(lwd = 2, border = "blue", add = TRUE)
...
```{r moz18, echo = FALSE, eval = TRUE, fig.height = 10, fig.width = 10, fig.align = "center"}
sofala_province |> sf::st_geometry() |> plot(lty = 0)
sofala_district |> sf::st_geometry() |> plot(add = TRUE)
moz_provinces |> sf::st_geometry() |> plot(add = TRUE)
sofala_province |> sf::st_geometry() |> plot(lwd = 2, border = "blue", add = TRUE)
